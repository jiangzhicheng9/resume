		...
		function gundong() {
			...
			// 电脑轮播
 		var nowweb = 0;
 		$(".page3 .tab .tab-ul .web .web-ul li:first").clone().appendTo(".page3 .tab .tab-ul .web .web-ul");
	 		function web(){
	 			if (nowweb < 6){
	 				nowweb++;
	 				$(".page3 .tab .tab-ul .web .web-ul").animate({"left":nowweb * -496}
			 				,1000);
	 			}else{
			 			nowweb = 0;
			 			$(".page3 .tab .tab-ul .web .web-ul").animate({"left":7 * -496}
			 				,1000
 		...
 		var timer1 = setInterval(web,2000);
		$(".page3 .tab .tab-ul .web .web-ul").hover(function(e) {
            clearInterval(timer1);
        },function(){
			timer1 = setInterval(web,2000);
		});
